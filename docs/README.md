...
| [正式采集与处理合同](collection-contract.md) | 数据源、完整性、质量门槛和性能合同 | v0.5.10 |
| [端到端部署指南](deployment.md) | Vultr 与校园 107 的部署顺序和验收 | v0.5.10 |
...
| 2026-08-26 | [双 WebSocket 主动冗余](2026-08-26-dual-websocket-redundancy-assessment.md) | 架构评估 |
