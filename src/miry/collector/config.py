...
class CollectorConfig(BaseModel):
    ...
    queue_max_bytes: int = Field(default=192 * 1024**2, ge=16 * 1024**2)
    ...
    writer_batch_events: int = Field(default=8_000, ge=100)
    writer_batch_bytes: int = Field(default=8 * 1024**2, ge=64 * 1024)
    ...
    @model_validator(mode="after")
    def validate_ratios(self) -> CollectorConfig:
